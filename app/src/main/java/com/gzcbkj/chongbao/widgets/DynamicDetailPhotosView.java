    ...
    public void setImageList(ArrayList<SayBean.SayImg> list){
        ...
        if(list==null || list.isEmpty()){
            ...
            if(size==1){
                ...
                Utils.loadImages(R.drawable.default_1,list.get(0).getImgUrl(),(ImageView) findViewById(R.id.iv1_1));
                ...
                Utils.loadImages(R.drawable.default_1,list.get(1).getImgUrl(),(ImageView) findViewById(R.id.iv1_2));
                findViewById(R.id.iv1_3).setVisibility(View.INVISIBLE);
                ...
                Utils.loadImages(R.drawable.default_1,list.get(2).getImgUrl(),(ImageView) findViewById(R.id.iv1_3));
                findViewById(R.id.vLine1_1).setVisibility(View.VISIBLE);
                ...
                Utils.loadImages(R.drawable.default_1,list.get(2).getImgUrl(),(ImageView) findViewById(R.id.iv2_1));
                findViewById(R.id.iv2_2).setVisibility(View.VISIBLE);
                Utils.loadImages(R.drawable.default_1,list.get(3).getImgUrl(),(ImageView) findViewById(R.id.iv2_2));
                ...
                findViewById(R.id.ll2).setVisibility(View.VISIBLE);
                findViewById(R.id.iv2_1).setVisibility(View.VISIBLE);
                Utils.loadImages(R.drawable.default_1,list.get(3).getImgUrl(),(ImageView) findViewById(R.id.iv2_1));
                findViewById(R.id.iv2_2).setVisibility(View.VISIBLE);
                Utils.loadImages(R.drawable.default_1,list.get(4).getImgUrl(),(ImageView) findViewById(R.id.iv2_2));
                findViewById(R.id.iv2_3).setVisibility(View.INVISIBLE);
                findViewById(R.id.vLine2_1).setVisibility(View.VISIBLE);
                findViewById(R.id.vLine2_2).setVisibility(View.INVISIBLE);
                findViewById(R.id.hLine2).setVisibility(View.GONE);
                ...
                Utils.loadImages(R.drawable.default_1,list.get(4).getImgUrl(),(ImageView) findViewById(R.id.iv2_2));
                findViewById(R.id.iv2_3).setVisibility(View.VISIBLE);
                Utils.loadImages(R.drawable.default_1,list.get(5).getImgUrl(),(ImageView) findViewById(R.id.iv2_3));
                findViewById(R.id.vLine2_1).setVisibility(View.VISIBLE);
                findViewById(R.id.vLine2_2).setVisibility(View.VISIBLE);
                ...
                Utils.loadImages(R.drawable.default_1,list.get(6).getImgUrl(),(ImageView) findViewById(R.id.iv3_1));
                ...
                Utils.loadImages(R.drawable.default_1,list.get(7).getImgUrl(),(ImageView) findViewById(R.id.iv3_2));
                findViewById(R.id.iv3_3).setVisibility(View.INVISIBLE);
                ...
                Utils.loadImages(R.drawable.default_1,list.get(8).getImgUrl(),(ImageView) findViewById(R.id.iv3_3));
                findViewById(R.id.vLine3_1).setVisibility(View.VISIBLE);
